...
<div class="related row">
    ...
    <h4 class="subheader"><?= __('Related GroupDocuments') ?></h4>
    <?php if (!empty($group->group_documents)): ?>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($group->group_documents as $groupDocuments): ?>
        <tr>
            ...
            <td class="actions">
                <?= $this->Html->link(__('View'), ['controller' => 'GroupDocuments', 'action' => 'view', $groupDocuments->id]) ?>

                <?= $this->Html->link(__('Edit'), ['controller' => 'GroupDocuments', 'action' => 'edit', $groupDocuments->id]) ?>

                <?= $this->Form->postLink(__('Delete'), ['controller' => 'GroupDocuments', 'action' => 'delete', $groupDocuments->id], ['confirm' => __('Are you sure you want to delete # {0}?', $groupDocuments->id)]) ?>
